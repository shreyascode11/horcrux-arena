  ...
  return (
    <div className="w-full h-full animate-fade-in max-w-7xl">
      ...
      <div className="grid grid-cols-12 gap-8">
        ...
        {/* 4. AI INSIGHT (Click Handler Added) */}
        <div 
          onClick={() => setView('analysis')} 
          className="col-span-12 lg:col-span-4 bg-[#0f0f0f] border border-white/5 rounded-[2rem] p-8 hover:scale-[1.02] transition cursor-pointer hover:border-blue-500/30"
        >
